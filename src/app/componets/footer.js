...
<footer className="text-gray-600 body-font">
  <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
    <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
        <Link href={"/"}> <Image src={"/logo.png"} alt="image" height={200} width={200}/></Link>
    ...
    <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
      ...
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav className="list-none mb-10">
          <li>
            <a className="text-gray-600 hover:text-gray-800">Wedding ceremony</a>
          </li>
          <li>
            <a className="text-gray-600 hover:text-gray-800">Ring ceremony</a>
          </li>
          <li>
            <a className="text-gray-600 hover:text-gray-800">Birthday party</a>
          </li>
          <li>
      ...
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav className="list-none mb-10">
          <li>
            <a className="text-gray-600 hover:text-gray-800">phone-nu:456-345-67</a>
          </li>
          <li>
            <a className="text-gray-600 hover:text-gray-800">Bussiness devllopment team surat</a>
          </li>
          <li>
            <a className="text-gray-600 hover:text-gray-800">Email:event@gmail.com</a>
          </li>
          {/* <li>
